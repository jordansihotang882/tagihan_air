...
class Tunggakan extends CI_Controller  {
	...
	public function index()
	{
		...
		$data['pemakaian'] = $this->db->query("SELECT * FROM tb_pemakaian pm, tb_pelanggan pl WHERE  pm.id_pelanggan=pl.id_pelanggan AND pm.id_pemakaian AND pm.bulan='$bulantahun' AND pm.status_pembayaran='0' ORDER BY pl.nama_pelanggan ASC ")->result();
	...
	public function input()
	{
		...
		$this->load->view('templates_admin/header');
		$this->load->view('templates_admin/sidebar',$data);
		$this->load->view('admin/form_input_tunggakan', $data);
		$this->load->view('templates_admin/footer');	
