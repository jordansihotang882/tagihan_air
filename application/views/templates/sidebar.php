        ...
        <aside class="menu-sidebar2">
            ...
            <div class="menu-sidebar2__content js-scrollbar1">
                <div class="account2">
                    ...
                    <a href="<?php echo base_url('auth_pelanggan/logout')?>">Sign out</a>
                </div>
                <nav class="navbar-sidebar2">
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li>
                            <a href="<?php echo base_url('pemakaian') ?>">
                        ...
                        <li>
                            <a href="<?php echo base_url('data_tunggakan') ?>">
                        ...
                        <li>
                        <li>
                            <a href="<?php echo base_url('auth_pelanggan/logout')?>">
