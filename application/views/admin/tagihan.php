	...
	<table class="table table-bordered 700px">
		...
		foreach($pemakaian as $pmk) : ?>
			<tr>
				...
				<a href="<?php echo base_url('admin/tagihan/konfirmasi_pembayaran/'.$pmk->id_pemakaian) ?>"><button class="btn btn-sm btn-warning"><i class="fas fa-check">Konfirmasi</i></button></a>
