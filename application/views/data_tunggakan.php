...
<table class="table table-bordered 700px">
       ...
       $total =($pmk->meter_akhir - $pmk->meter_awal)*500;
			$grandtotal += $total;
			?>
			...
			<tr>
				...
				<td><?php if ($pmk->bulan =='012020')  { 
				 ...
				 <td><?php echo substr($pmk->bulan, 2) ?></td>
					<td>Rp. <?php echo number_format($pmk->meter_akhir - $pmk->meter_awal) ?></td>
			...
			<tr>
				...
				<td colspan="2">Rp. <?php echo number_format($grandtotal)?></td>
			</tr>
